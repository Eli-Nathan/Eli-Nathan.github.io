...
/*#__PURE__*/
function (_Component) {
  _inherits(SocialCard, _Component);

  function SocialCard(props) {
    var _this;

    _classCallCheck(this, SocialCard);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SocialCard).call(this, props));
    _this.toggleLike = _this.toggleLike.bind(_assertThisInitialized(_assertThisInitialized(_this))); // Set initial state for likes
  ...
  _createClass(SocialCard, [{
    ...
    value: function render() {
      ...
      }), _react.default.createElement("h5", null, this.props.data['user'])), _react.default.createElement("div", {
        className: "card__post"
      }, _react.default.createElement("p", null, this.props.data['content'])), _react.default.createElement("div", {
      ...
      }, _react.default.createElement("h4", null, this.props.data['title']), _react.default.createElement("h6", null, this.props.data['date']), _react.default.createElement("div", {
        className: "interactions"
      }, _react.default.createElement("button", {
        className: this.state.likeClass,
        onClick: this.toggleLike
      }, this.state.likes), _react.default.createElement("button", {
        className: "interactions__icon interactions__icon--comments"
      }, "0"), _react.default.createElement("button", {
        className: "interactions__icon interactions__icon--share"
      }, "0"))));
    }
  }]);
...
var _SocialCard = _interopRequireDefault(require("./SocialCard"));
...
},{"./SocialCard":1,"react":12,"react-dom":9}],3:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
